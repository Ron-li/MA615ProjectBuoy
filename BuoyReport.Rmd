...
Part1: Precessing the data. In the Raw_data.R, I put the code about processing the raw data in it.  
...
## My conlusions
There is no conclusive evidence of global warming in this data.
